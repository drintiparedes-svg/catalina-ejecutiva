...
total=0; malos=0
for t in qa-identidad qa-dom qa-rutas qa-prompts qa-escucha qa-bilingue qa-telefonia qa-adjuntos qa-correo qa-drive qa-docs qa1 qa2 qa3 qa4 qa5 qa6 qa7 qa8; do
